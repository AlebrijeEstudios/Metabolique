...
namespace AppVidaSana.Models.Alimentación
{
    ...
    {
        [Key]
        public Guid dinnerID { get; set; } = Guid.NewGuid();
        ...
        public DateOnly dateDinner { get; set; }

        [Required(ErrorMessage = "El campo hora es obligatorio")]
        [DataType(DataType.Time)]
        public TimeOnly hourDinner { get; set; }
        ...
        public ICollection<FoodsDinner> foodsDinner { get; set; } = new List<FoodsDinner>();
    }
}
